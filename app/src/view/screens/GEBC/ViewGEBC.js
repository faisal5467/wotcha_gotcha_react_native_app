...
export default function ViewGEBC({navigation, route}) {
  ...
  const fetchComments = async value => {
    ...
    try {
      const response = await fetch(
        base_url + `gebc/getAllCommentsByGEBC/${receivedData?.gebc_id}`,
        {
          method: 'GET',
          headers: {
  ...
  const fetchLikes = async values => {
    ...
    try {
      const response = await fetch(
        base_url + `gebc/getAllLikesByGEBC/${receivedData?.gebc_id}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
